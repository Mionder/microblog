                        ...
                        posts.map(item => {
                            ...
                            return (
                                <div className="blog" key={id}>
                                    ...
                                    <svg onClick={() => deletePost(id)} width="32px" height="32px" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="trash-alt"
                                    ...
                                    <svg  width="32px" height="32px" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="pencil-alt"
